...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty _joystickOutputEvent;
    ...
    protected virtual void OnEnable()
    {
        ...
        _joystickOutputEvent = serializedObject.FindProperty("_joystickOutputEvent");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(_joystickOutputEvent, new GUIContent("Output Direction Vector2D"));
    }
