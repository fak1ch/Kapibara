...
{
    public string GAME_ID = "4763307"; //replace with your gameID from dashboard. note: will be different for each platform.
    ...
    public void Initialize()
    {
        ...
        {
            DebugLog(Application.platform + "NOT supported by Advertisement");
        }
    }
